...
const CONTROL =
  "rounded-md border border-border bg-surface px-3 text-base sm:text-sm text-foreground shadow-xs placeholder:text-faint outline-none focus:border-accent focus:ring-2 focus:ring-accent/20";
